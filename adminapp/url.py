...
urlpatterns = [
    ...
    path('categories/read/', adminapp.ProductCategoriesView.as_view(), name='categories'),
    ...
    path('products/read/<int:pk>/', adminapp.ProductDetalView.as_view(), name='product_read'),
